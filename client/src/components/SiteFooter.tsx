      ...
      <div className="footer-main">
        <div className="footer-brand-column">
          <Link href="/" className="brand-lockup" aria-label="Nexus A Liverton Store home">
            <img src="/logo.png" alt="Nexus Logo" className="brand-logo-img h-7 w-auto object-contain" />
          ...
          <div className="footer-socials flex flex-wrap gap-2.5 mt-3">
            <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="social-icon hover:opacity-80 transition-opacity" aria-label="TikTok">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 1 1-5.2-1.74 2.89 2.89 0 0 1 2.31-1.22v-3.5a6.38 6.38 0 1 0 6.34 6.38V9.7a8.27 8.27 0 0 0 4.77 1.52V7.72a4.85 4.85 0 0 1-1-.03z"/></svg>
            </a>
